  ...
  val expect = sbtBinaryVersion.value match {
    ...
    case "2" =>
      Set(
        ...
        s"target/out/jvm/scala-3.8.1/${name.value}/src_managed/test/sbt_doctest/FailingOneDoctest.scala",
        s"target/out/jvm/scala-3.8.1/${name.value}/src_managed/test/sbt_doctest/MainDoctest.scala",
        s"target/out/jvm/scala-3.8.1/${name.value}/src_managed/test/sbt_doctest/VerbatimTestDoctest.scala",
