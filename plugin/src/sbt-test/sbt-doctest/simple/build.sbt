  ...
  val expect = sbtBinaryVersion.value match {
    ...
    case "2" =>
      Set(
        ...
        s"target/out/jvm/scala-3.8.0/${name.value}/src_managed/test/DocREADMEmd1Doctest.scala",
        s"target/out/jvm/scala-3.8.0/${name.value}/src_managed/test/READMEmd0Doctest.scala",
        s"target/out/jvm/scala-3.8.0/${name.value}/src_managed/test/sbt_doctest/FailingOneDoctest.scala",
        s"target/out/jvm/scala-3.8.0/${name.value}/src_managed/test/sbt_doctest/MainDoctest.scala",
        s"target/out/jvm/scala-3.8.0/${name.value}/src_managed/test/sbt_doctest/VerbatimTestDoctest.scala",
